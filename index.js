        ...
        tobz.onAddedToGroup(async (chat) => {
            ...
            if(mtcState === false){
                ...
                if(groups.length > groupLimit){
                    await tobz.sendText(chat.id, 'Maaf, Batas group yang dapat Miqdad Mods tampung sudah penuh').then(async () =>{
                    ...
                    if(chat.groupMetadata.participants.length < memberLimit){
                        ...
                        if(!chat.isReadOnly) tobz.sendText(chat.id, 'Halo aku Miqdad Mods, Ketik #help Untuk Melihat List Command Ku...')
                    }
                }
            }else{
